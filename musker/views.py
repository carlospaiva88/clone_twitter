...
def unfollow(request, pk):
    if request.user.is_authenticated:
        ...
        # Return message
        messages.success(request, (f'You have successfuly unfollowed {profile.user.username}'))
...
def follow(request, pk):
    if request.user.is_authenticated:
        ...
        # Return message
        messages.success(request, (f'You have successfuly followed {profile.user.username}'))
        return redirect(request.META.get('HTTP_REFERER'))
...
def followers(request, pk):
    if request.user.is_authenticated:
        if request.user.id == pk:
            ...
            messages.success(request, ('You are in the wrong page..'))
        return redirect('home')
...
def tweet_like(request, pk):
    if request.user.is_authenticated:
        ...
        messages.success(request, ('You must been logged in to view this page.. !'))
    return redirect('home')
